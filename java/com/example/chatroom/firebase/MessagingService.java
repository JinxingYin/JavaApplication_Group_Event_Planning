package com.example.chatroom.firebase;
...
import com.example.chatroom.activities.ChatActivity;
...
public class MessagingService extends FirebaseMessagingService {
    ...
    public void onNewToken(@NonNull String token){
        ...
        Log.d("Token", "Here is the token from the registered device: " + token);
    }
